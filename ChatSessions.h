...
typedef bool (*CHATCALLBACKSYSFUNCPTR)(std::string &, std::string &, int *, int, void *);
...
public:
	...
	inline const CHATCALLBACKSYSFUNCPTR GetSystemFunction() { return m_SystemCallback; }
	inline void SetSystemFunction(CHATCALLBACKSYSFUNCPTR val) { m_SystemCallback = val; }
