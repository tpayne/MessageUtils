...
MessengerApps::clear()
{
	...
	for(Chats::iterator i = m_Chats.begin(); 
		i != m_Chats.end(); ++i)
		delete *i;
	m_Chats.clear();
...
bool
MessengerApps::ParseArgs(const int argc, const char **argv)
{
	return false;
}
...
void
MessengerApps::Usage(const int argc, const char **argv)
{
	return;
}
...
void
MessengerApps::RemoveContact(const std::string *contact)
{
...
void
MessengerApps::AddContact(const std::string *contact)
{
	std::string conN(contact->c_str());
...
void
MessengerApps::AddGroup(const std::string *grp)
{
...
bool
MessengerApps::ChatEstablished(const std::string *contact)
{
...
bool
MessengerApps::StartChat(const char *who)
{
	return false;
}

bool
MessengerApps::StartChat(const std::string *who)
{
	return false;
}
...
bool
MessengerApps::ResetAlias(const char *who)
{
	return false;
}

bool
MessengerApps::ResetAlias(const std::string *who)
{
	return false;
}
...
MessengerApps::ReadConfigFile()
{
	...
	{		
		...
		if (symbol.find("=")!=std::string::npos)
		{
			...
			std::string symbolValue = StrUtils::SubStr(symbol,(symbol.find("="))+1,symbol.length());
...
const char* 
MessengerApps::GetSymbol(const char *symbolName)
{
	if (symbolName == NULL)
		return NULL;
...
const char* 
MessengerApps::GetSymbol(std::string& symbolName)
{
